pdf("HBRRep1.splice_events.pdf")
events=c(0.6640558487995913,0.161757193938362,99.16141665247744)
...
dev.off()
pdf("HBRRep1.splice_junction.pdf")
junction=c(3.2351989647363313,0.8411517308314461,95.92364930443222)
